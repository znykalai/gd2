    ...
    public static Hashtable<String,Integer> getMap(){
    	//缓存工位
    	     if(map.size()==0){ 
                  ...
                  map.put(堆垛机1+"1ST", 513); map.put(堆垛机1+"2ST", 511);
                  map.put(堆垛机1+"3ST", 509); map.put(堆垛机1+"4ST", 507);
                  map.put(堆垛机1+"5ST", 505); map.put(堆垛机1+"6ST", 503);map.put(堆垛机1+"7ST", 501);
                  
                  map.put(堆垛机2+"1ST", 613); map.put(堆垛机2+"2ST", 611);
                  map.put(堆垛机2+"3ST", 609); map.put(堆垛机2+"4ST", 607);
                  map.put(堆垛机2+"5ST", 605); map.put(堆垛机2+"6ST", 603);map.put(堆垛机2+"7ST", 601);
    	     }
