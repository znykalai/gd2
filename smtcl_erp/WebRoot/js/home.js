var af_Home={
	...
	winHtmlEvent:function(){
		$("#A").click(function(){
			var e=af_Home.action(this,'A',af_Home.butClick);e=null;
			return null;
		});
		$("#B").click(function(){
			var e=af_Home.action(this,'B',af_Home.butClick);e=null;
			return null;
		});
		$("#C").click(function(){
			var e=af_Home.action(this,'C',af_Home.butClick);e=null;
			return null;
		});
		$("#D").click(function(){
			var e=af_Home.action(this,'D',af_Home.butClick);e=null;
			return null;
		});
	...
	load:function(fun){
		...
		$(document).keydown(function (event) {
	        if (event.keyCode == 122) {
	        	var a=window.location.reload();a=null;
				return null;
	        };
	    });
		//显示主页;
		var a=$('#anniu2').click();a=null;
		//定时更新急停按钮状态
