...
var af_Home={
	...
	winHtmlEvent:function(){
		...
		if(this.administrator.启动库指令){var a=$("#E").click(function(){var e=af_Home.action(this,'E',af_Home.butClick);e=null;return null;});a=null;}else{var a=af_Home.cleanQX("E");a=null;};
		if(this.administrator.启动库指令){var a=$("#F").click(function(){var e=af_Home.action(this,'F',af_Home.butClick);e=null;return null;});a=null;}else{var a=af_Home.cleanQX("F");a=null;};
